...
namespace Redis.Sentinel.Controllers
{
    ...
    [ApiController]
    public class RedisSentinelController : ControllerBase
    { 
        //localhost:4200/api/redisSentinel/setvalue/name/ismail
        ...
        //localhost:4200/api/redisSentinel/getvalue/name
        [HttpGet("[action]/{key}")]
